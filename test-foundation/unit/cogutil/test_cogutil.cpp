// Unit test for cogutil - Foundation Layer
...
int main() {
    std::cout << "Running cogutil unit tests..." << std::endl;
    
    opencog::cogutil::TensorValidator validator;
    ...
    std::cout << "cogutil unit tests completed successfully!" << std::endl;
    return 0;
}
