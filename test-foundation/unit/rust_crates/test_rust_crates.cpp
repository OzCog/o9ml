// Unit test for rust_crates - Foundation Layer
...
int main() {
    std::cout << "Running rust_crates unit tests..." << std::endl;
    
    opencog::rust_crates::TensorValidator validator;
    ...
    std::cout << "rust_crates unit tests completed successfully!" << std::endl;
    return 0;
}
