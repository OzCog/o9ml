// Unit test for external-tools - Foundation Layer
...
int main() {
    std::cout << "Running external-tools unit tests..." << std::endl;
    
    opencog::external-tools::TensorValidator validator;
    ...
    std::cout << "external-tools unit tests completed successfully!" << std::endl;
    return 0;
}
