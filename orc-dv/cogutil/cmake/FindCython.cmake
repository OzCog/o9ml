...
ELSE()
	SET(CYTHON_VERSION_OK TRUE)
ENDIF(CYTHON_EXECUTABLE AND CMAKE_VERSION VERSION_GREATER "2.6.0")

IF (DEFINED Cython_FIND_VERSION)
	IF (CYTH_VERSION)
		SET(_CYTH_VERSION_MESSAGE_STRING "(${CYTH_VERSION} >= ${Cython_FIND_VERSION})")
	ELSE ()
		SET(_CYTH_VERSION_MESSAGE_STRING "(version unknown >= ${Cython_FIND_VERSION})")
	ENDIF ()
ELSE ()
	IF (CYTH_VERSION)
		SET(_CYTH_VERSION_MESSAGE_STRING "(${CYTH_VERSION})")
	ELSE ()
		SET(_CYTH_VERSION_MESSAGE_STRING "(version unknown)")
	ENDIF ()
ENDIF ()

# Report the results.
IF (CYTHON_FOUND AND CYTHON_VERSION_OK)
